...
`mkdocs-simple-blog` is for people who want a personal blog or a small
documentation site without pulling in a full framework's worth of
...
Posts / Categories / Tags widgets — no manual list-editing required.
