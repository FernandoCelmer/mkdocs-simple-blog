...
def test_theme_default_config():
    ...
    assert 'navigation_depth' in theme, "theme should have 'navigation_depth' key"
...
def test_theme_plugin_registration():
    ...
    assert 'mkdocs.themes' in content, "Should have mkdocs.themes plugin configuration"
    assert 'simple-blog' in content, "Theme should be registered as 'simple-blog'"
    assert 'mkdocs_simple_blog' in content, "Theme should point to 'mkdocs_simple_blog' package"
